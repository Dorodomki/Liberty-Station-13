...
/datum/category_item/setup_option/background/path/labourer
	...
	stat_modifiers = list(STAT_ROB = 5, STAT_BIO = -5, STAT_MEC = 10,STAT_TGH = 5, STAT=COG = -5)
...
/datum/category_item/setup_option/background/path/noble
	...
	stat_modifiers = list(STAT_ROB = -5, STAT_TGH = -5, STAT_COG = 10, STAT_BIO = -5, STAT_MEC = -5, STAT_VIG = -5)
